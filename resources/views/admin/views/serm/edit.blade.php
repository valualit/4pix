...
<div class="form-group">
	...
	<div class="input-group">
		...
		<input type="text" class="form-control" id="name" name="project[name]" value="{{$Project->name}}" required placeholder="{{ __('Название проекта') }}" />
	</div>
</div> 
<div class="form-group">
	...
	<div class="input-group">
		...
		<input type="text" class="form-control" id="url" name="project[url]" value="{{$Project->url}}" required placeholder="{{ __('URL адрес/домен') }}" />
	</div>
</div> 
<div class="form-group">
	...
	<div class="input-group">
		...
		<option value="{{$user->id}}"{{$user->id==$Project->user?' selected':null}}>{{$user->name}}</option>
		@endforeach
		</select>
	</div>
</div> 
